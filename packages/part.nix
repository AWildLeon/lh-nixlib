...
in
{
  perSystem =
    { pkgs, pkgsUnstable, ... }:
    {
      ...
      packages.linux-lts-desktop-lhmod = pkgs.callPackage ./linux-lts-desktop-lhmod/package.nix { inherit maintainers; };
      packages.linux-lts-server-lhmod = pkgs.callPackage ./linux-lts-server-lhmod/package.nix { inherit maintainers; };
    };
}
